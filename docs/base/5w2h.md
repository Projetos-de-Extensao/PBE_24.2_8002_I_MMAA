...
|Where? (Onde será feito?)|O trabalho será realizado no IBMEC na disciplina de projeto backend.|
|When? (Quando será feito?)|Durante o semestre 2024.2.|
|Who? (Quem irá fazer?)|A equipe será formada pelos alunos Alex Cyrillo,...|
...
| -- | -- | -- | -- |
| 23/08/24 | 1.0 | Criação do documento | xxx xxxx | 
